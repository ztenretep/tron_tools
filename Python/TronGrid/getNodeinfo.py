...
The given ListExchanges example was adapted for use with the TRON Mainnet. The
request is using the GET method. The output of the response of the script is
given as structured JSON data. Possible exceptions are not kept at the moment.
