...
Accordingly, I was looking for a way to do everything necessary from the command line on myself. With the <mark>tronapi</mark> from PyPi I found a Python package
